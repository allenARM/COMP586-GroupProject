...
public partial class LivingRoom : ContentPage
{
    ...
    public void LivingRoomLight(object sender, EventArgs e)
    {
        ...
        AddDeviceToRoomCommand addDeviceToRoomCommand = new AddDeviceToRoomCommand(Globals.livingRoom,light);
        ...
        void OnClick(object sender, EventArgs e)      /* device deleted, pop off display stack */
        {
            ...
            RemoveDeviceFromRoomCommand removeDeviceFromRoomCommand = new RemoveDeviceFromRoomCommand(Globals.livingRoom, light);
    ...
    private void LivingRoomSpeaker(object sender, EventArgs e)
    {
        ...
        AddDeviceToRoomCommand addDeviceToRoomCommand = new AddDeviceToRoomCommand(Globals.livingRoom, speaker1);
        Controller controller = new Controller(addDeviceToRoomCommand);
        controller.ExecuteCommand();
        ...
        void OnClick(object sender, EventArgs e)                /* device deleted, pop off display stack */
        {
            ...
            RemoveDeviceFromRoomCommand removeDeviceFromRoomCommand = new RemoveDeviceFromRoomCommand(Globals.livingRoom,speaker1);
    ...
    private void LivingRoomThermostat(object sender, EventArgs e)
    {
        ...
        AddDeviceToRoomCommand addDeviceToRoomCommand = new AddDeviceToRoomCommand(Globals.livingRoom, thermostat1);
        Controller controller = new Controller(addDeviceToRoomCommand);
        controller.ExecuteCommand();
        ...
        void OnClick(object sender, EventArgs e)                 /* device delete, pop off display stack */
        {
            ...
            RemoveDeviceFromRoomCommand removeDeviceFromRoomCommand = new RemoveDeviceFromRoomCommand(Globals.livingRoom, thermostat1);
            Controller controller = new Controller(removeDeviceFromRoomCommand);
            controller.ExecuteCommand();
        }
    ...
    public void LivingRoomTv(object sender, EventArgs e)
    {
        ...
        AddDeviceToRoomCommand addDeviceToRoomCommand = new AddDeviceToRoomCommand(Globals.livingRoom, tv);
        Controller controller = new Controller(addDeviceToRoomCommand);
        controller.ExecuteCommand();
        ...
        void OnClick(object sender, EventArgs e)                 /* device delete, pop off display stack */
        {
            ...
            RemoveDeviceFromRoomCommand removeDeviceFromRoomCommand = new RemoveDeviceFromRoomCommand(Globals.livingRoom, tv);
            Controller controller = new Controller(removeDeviceFromRoomCommand);
            controller.ExecuteCommand();
        }
    ...
    private void LivingRoomOutlet(object sender, EventArgs e)
    {
        ...
        AddDeviceToRoomCommand addDeviceToRoomCommand = new AddDeviceToRoomCommand(Globals.livingRoom, outlet1);
        Controller controller = new Controller(addDeviceToRoomCommand);
        controller.ExecuteCommand();
        ...
        void OnClick(object sender, EventArgs e)                 /* device delete, pop off display stack */
        {
            ...
            RemoveDeviceFromRoomCommand removeDeviceFromRoomCommand = new RemoveDeviceFromRoomCommand(Globals.livingRoom, outlet1);
            Controller controller = new Controller(removeDeviceFromRoomCommand);
            controller.ExecuteCommand();
        }
    ...
    private void LivingRoomCamera(object sender, EventArgs e)
    {
        ...
        AddDeviceToRoomCommand addDeviceToRoomCommand = new AddDeviceToRoomCommand(Globals.livingRoom, camera1);
        Controller controller = new Controller(addDeviceToRoomCommand);
        controller.ExecuteCommand();
        ...
        void OnClick(object sender, EventArgs e)                 /* device delete, pop off display stack */
        {
            ...
            RemoveDeviceFromRoomCommand removeDeviceFromRoomCommand = new RemoveDeviceFromRoomCommand(Globals.livingRoom, camera1);
            Controller controller = new Controller(removeDeviceFromRoomCommand);
            controller.ExecuteCommand();
        }
    ...
    private void LivingRoomLock(object sender, EventArgs e)
    {
        ...
        AddDeviceToRoomCommand addDeviceToRoomCommand = new AddDeviceToRoomCommand(Globals.livingRoom, lock1);
        Controller controller = new Controller(addDeviceToRoomCommand);
        controller.ExecuteCommand();
        ...
        void OnClick(object sender, EventArgs e)                 /* device delete, pop off display stack */
        {
            ...
            RemoveDeviceFromRoomCommand removeDeviceFromRoomCommand = new RemoveDeviceFromRoomCommand(Globals.livingRoom, lock1);
            Controller controller = new Controller(removeDeviceFromRoomCommand);
            controller.ExecuteCommand();
        }
